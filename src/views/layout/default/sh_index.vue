<template lang="pug">
.layout-wrap
  .layout-main(:class="{'android': $isAndroid}")
...
export default {
  ...
  methods: {
    ...
    resolveFooterVisible (_name) {
      if (_name === 'meeting.index' || _name === 'meetingVerify.index' || _name === 'my.index' || _name === 'meetingRoom.index') {
