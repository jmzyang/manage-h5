          ...
          .contacts-list
            van-checkbox.contacts-item(
              ...
              template(v-else)
                ...
                .name(style='text-align:left;width:0.8rem;')
                  h2(style='overflow:hidden;text-overflow:ellipsis;white-space:nowrap;') {{item.USER_NAME}}
...
import OrgCard from '@/views/meeting/components/c-organization/c-org-card'
