...
let jsEncrypt = {}
jsEncrypt.des = function (key, message, encrypt, mode, iv) {
  ...
  var keys = jsEncrypt.des_createKeys(key)
...
jsEncrypt.des_createKeys = function (key) {
  // declaring this locally speeds things up a bit
...
/// /////////////////////////// 测试 //////////////////////////////
jsEncrypt.stringToHex = function (s) {
  var r = ''
...
jsEncrypt.HexTostring = function (s) {
  var r = ''
...
jsEncrypt.decrypt = function (enStr, key) {
  enStr = jsEncrypt.HexTostring(enStr)
  var str = jsEncrypt.des(key, enStr, 0, 0)
  return str
}

// 使用key为frame加密
jsEncrypt.encrypt = function (enStr, key) {
  if (typeof key === 'number') {
    key = key.toString()
  }
  var str = jsEncrypt.des(key || '888888', enStr, 1, 0)
  str = jsEncrypt.stringToHex(str)
  return str
}
const resolveXml = (json) => {
